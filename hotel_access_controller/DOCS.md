...
Version `0.1.0-dev.57` is the Home Assistant OS add-on that connects a hotel
...
`ghcr.io/issmata/hotel-access-controller-addon:0.1.0-dev.57`.
...
`0.1.0-dev.57` retains `controller.capability_manager.v1` in normal Controller
...
For a `0.1.0-dev.57` canary, also verify that unknown capability IDs are
