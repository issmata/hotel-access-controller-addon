...
Release `0.1.0-dev.58` includes idempotent recovery when a requested PIN is
already present in an occupied slot and retains the authenticated inventory-upload result path
